...
const DownloadApp = () => {
    return (
        <div className="my-20 lg:h-[520px] relative overflow-hidden bg-cover bg-no-repeat" style={{ backgroundImage: 'url(https://i.ibb.co/DL6CBrZ/background-image-01.jpg)' }}>
            ...
            <div className="max-w-5xl mx-auto flex px-5 py-10 md:p-10 lg:p-0 flex-col-reverse lg:flex-row justify-between gap-10 items-center relative z-10">
                ...
                <div className=" flex gap-10">
                    <img className="opacity-80 h-[279px] w-[105px] lg:h-full lg:w-full" src="https://i.ibb.co/bWWXdv2/iphone-white.png" alt=""  />
                    <img className="opacity-80 h-[279px] w-[105px] lg:h-full lg:w-full" src="https://i.ibb.co/q5SzQmP/iphone-black-207x545.png" alt="" />
                </div>
            </div>
        </div>
    );
