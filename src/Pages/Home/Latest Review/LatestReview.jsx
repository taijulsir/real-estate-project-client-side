...
const LatestReview = () => {
    ...
    return (
        <div className="my-16">
                ...
                >
                    {reviews?.slice(0, 6).map(review => (
                        <SwiperSlide key={review?._id}>
                            <div classNameName=" bg-amber-600 px-8 py-10 shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)]  rounded-2xl font-[sans-serif] overflow-hidden  mt-4">
                                <div classNameName="flex flex-col items-center">
                                    <img src={review.reviewerImage} classNameName="w-60 h-60 rounded-full" alt={review.reviewerName} />
                                    <div classNameName="mt-6 text-center">
                                        <p classNameName="text-base text-gray-400 font-bold uppercase">{review.reviewerName}</p>
                                        <h3 classNameName="text-white font-bold text-xl mt-4">{review.reviewDescription}</h3>
                                    </div>
                                </div>
                            </div>
                        </SwiperSlide>
            ...
            <div className="mt-4">
              <p className="text-sm leading-relaxed">The service was amazing. I never had to wait that long for my food. The staff was friendly and attentive, and the delivery was impressively prompt. Elit occaecat officia et laboris Lorem minim. Officia do aliqua adipisicing ullamco in.</p>
            </div>
          </div>)}
                </div>
            </div>
