                            ...
                            <div className="flex justify-between gap-5">
                                ...
                                <div className="mt-10 flex items-center flex-1">
                                    <button
                                        ...
                                        type="button"
                                        className="btn px-6 hvr-sweep-to-top py-2 rounded w-full text-[#333] text-sm tracking-wider font-semibold border-2 border-[#333] hover:bg-gray-50 outline-none">Delete
                                    </button>
                                </div>
                            </div>
                        </div>
