                            ...
                            <div className="relative">
                                <select name="" id="" className=" outline-none border-none text-zinc-200" style={{ background: 'none' }}>
                                    <option value="English" className=" text-zinc-950">
                                        <img src="https://themes.g5plus.net/benaa/wp-content/uploads/2018/01/en.png" alt="" className=" inline mr-2" />English</option>
                                    <option value="" className=" text-zinc-950">
                                        <img src="https://themes.g5plus.net/benaa/wp-content/uploads/2018/01/ja.png" alt="" className=" inline mr-2" />Bangla</option>
                                    <option value="" className=" text-zinc-950">
                                        <img src="https://themes.g5plus.net/benaa/wp-content/uploads/2018/01/de.png" alt="" />Hindi</option>
                                </select>
                            </div>
                            {/*Search bar */}
                            <div>
                                <div className=" flex px-4 py-3  border-b border-black  focus-within:border-blue-500 overflow-hidden max-w-md mx-auto font-[sans-serif]">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.904 192.904" width="18px" className="fill-black mr-3  ">
                                        <path
